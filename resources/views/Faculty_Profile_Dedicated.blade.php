...
<body>
    <header class="topbar">
        <a href="{{ route('faculty.dashboard') }}" class="topbar-brand">
        ...
        <div class="topbar-right">
            ...
            <div class="topbar-actions">
                <a href="{{ route('faculty.dashboard') }}" class="topbar-link">Back</a>
                <form action="{{ route('logout') }}" method="POST" style="display:inline;">
                    @csrf
                    <button type="submit" class="topbar-button">Logout</button>
                </form>
                <a href="{{ route('faculty.profile') }}" class="topbar-avatar">
