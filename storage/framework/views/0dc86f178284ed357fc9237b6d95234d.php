            ...
            <section class="courses-col">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="course-card">
                        ...
                        <a href="<?php echo e(route('faculty.analytics', ['course_id' => $course->id ?? null])); ?>" style="margin-left:8px;">
                ...
                <div class="panel" style="min-height:auto;">
                    ...
                    <div class="panel-body">
                        <div class="quick-actions">
                            <a class="btn-quick" href="<?php echo e(route('students.index')); ?>">View Students</a>
...
</html><?php /**PATH C:\Users\Admin\Herd\Micro-credentials\resources\views/Faculty_dashboard.blade.php ENDPATH**/ ?>