...
<header class="topbar">
    <div class="brand">
        <span class="logo"><img src="<?php echo e(asset('images/PSU-Logo.png')); ?>" alt="PSU Logo"></span>
        <h1>UPSKILL</h1>
    </div>
    <nav class="nav-pills">
    ...
    <div class="icon-cluster">
        <a href="<?php echo e(route('notifications.index')); ?>" class="icon-circle">
            ...
            <div class="module-group <?php echo e($mIndex > 0 ? 'module-locked' : ''); ?>" id="mg-<?php echo e($mIndex); ?>">
                ...
                <div class="module-toggle">
                    <div class="module-title-area" id="mta-<?php echo e($mIndex); ?>"
                         onclick="showModuleWelcome('<?php echo e(addslashes($module->title)); ?>',<?php echo e($module->lessons->count()); ?>,<?php echo e($modules->count()); ?>,<?php echo e($badge_count ?? 1); ?>,<?php echo e($mIndex); ?>)">
                ...
                <div class="lesson-list <?php echo e($mIndex===0?'open':''); ?>" id="mod-<?php echo e($mIndex); ?>">
                    <?php $__currentLoopData = $module->lessons ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lIndex => $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="lesson-item"
                             ...
                             data-lid="<?php echo e($mIndex); ?>-<?php echo e($lIndex); ?>"
                             onclick="<?php echo e($isVid ? 'loadVideoLesson' : 'loadTextLesson'); ?>(
                                 '<?php echo e(addslashes($lesson->title)); ?>',
                                 '<?php echo e(addslashes($lesson->description ?? $lesson->title)); ?>',
                                 '<?php echo e($lesson->duration ?? '15m'); ?>',
                    ...
                    <div class="quiz-row">
                        <div>
                            ...
                            <div class="quiz-info-sub"><?php echo e($module->quiz->questions_count ?? 3); ?> questions · Pass <?php echo e($module->quiz->passing_score ?? 75); ?>%</div>
                        </div>
...
</html><?php /**PATH C:\Users\Admin\Herd\Micro-credentials\resources\views/Student_Course_Enrollment.blade.php ENDPATH**/ ?>