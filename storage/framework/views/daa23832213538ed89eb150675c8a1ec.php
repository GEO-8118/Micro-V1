...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sb-section open" id="sec-manage">
        ...
        <div class="sb-items">
            ...
            <a href="<?php echo e(route('admin.courses')); ?>" class="sb-item active">
    ...
    <div class="course-grid">
        ...
        <div class="course-card">
            ...
            <div class="course-card-meta">
                <?php echo e($course->students); ?> Students . <?php echo e($course->faculty); ?> Faculty .<br>
                Badge: <?php echo e($course->badge); ?>

            </div>

            <div class="progress-track">
                <div class="progress-fill" style="width: <?php echo e($course->percent); ?>%"></div>
            </div>

            <div class="course-card-pct"><?php echo e($course->percent); ?>% Complete</div>
        </div>
...
</html><?php /**PATH C:\Users\Admin\Herd\Micro-credentials\resources\views/Admin_Management_Course_&_Badges.blade.php ENDPATH**/ ?>