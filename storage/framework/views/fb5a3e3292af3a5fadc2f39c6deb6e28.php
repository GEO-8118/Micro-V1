...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sb-section open" id="sec-main">
        ...
        <div class="sb-items">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="sb-item">
    ...
    <div class="sb-section open" id="sec-manage">
        ...
        <div class="sb-items">
            ...
            <a href="<?php echo e(route('admin.usermanagement')); ?>" class="sb-item active">
        ...
        <table class="um-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="status-badge <?php echo e($course->badge_status === 'Active' ? 'status-active' : 'status-pending'); ?>">
                            <?php echo e($course->badge_status); ?>

                        </span>
                    </td>
                    <td>
                        <span class="status-badge <?php echo e($course->publish_status === 'Published' ? 'status-published' : 'status-draft'); ?>">
                            <?php echo e($course->publish_status); ?>
...
</html><?php /**PATH C:\Users\Admin\Herd\Micro-credentials\resources\views/Admin_Management_UserManage.blade.php ENDPATH**/ ?>