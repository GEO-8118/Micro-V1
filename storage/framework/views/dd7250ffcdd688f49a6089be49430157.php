...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sb-section open" id="sec-analytics">
        ...
        <div class="sb-items">
            ...
            <a href="<?php echo e(route('admin.report')); ?>" class="sb-item active">
...
<main class="main">
    ...
    <div class="stats-grid">
        <div class="stat-card">
            <div class="stat-val"><?php echo e($stats['total_students']); ?></div>
            <div class="stat-lbl">Total Students</div>
        </div>
        <div class="stat-card">
            <div class="stat-val"><?php echo e($stats['badges_issued']); ?></div>
            <div class="stat-lbl">Badges Issued</div>
        </div>
        <div class="stat-card">
            <div class="stat-val"><?php echo e($stats['faculty_total']); ?></div>
            <div class="stat-lbl">Faculty Total</div>
        </div>
        <div class="stat-card">
            <div class="stat-val"><?php echo e($stats['course_score_avg']); ?>%</div>
...
<?php /**PATH C:\Users\Admin\Herd\Micro-credentials\resources\views/Admin_Analytics_Report.blade.php ENDPATH**/ ?>