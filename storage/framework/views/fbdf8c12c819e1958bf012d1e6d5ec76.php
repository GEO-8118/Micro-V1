...
<div class="layout">
    ...
    <main class="main">
        ...
        <form method="POST" action="<?php echo e(route('faculty.create.store')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
        ...
        <div class="form-actions">
            ...
            <a href="<?php echo e(route('faculty.dashboard')); ?>"><button class="btn-cancel" type="button">Cancel</button></a>
        </div>
...
</html><?php /**PATH C:\Users\Admin\Herd\Micro-credentials\resources\views/Faculty_Create_Courses.blade.php ENDPATH**/ ?>